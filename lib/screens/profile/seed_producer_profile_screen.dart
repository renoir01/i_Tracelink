...
class SeedProducerProfileScreen extends StatefulWidget {
  const SeedProducerProfileScreen({super.key});

  @override
  State<SeedProducerProfileScreen> createState() => _SeedProducerProfileScreenState();
}

class _SeedProducerProfileScreenState extends State<SeedProducerProfileScreen> {
  ...
  // Seed varieties
  final List<SeedVariety> _seedVarieties = [];
  ...
  Future<void> _submitProfile() async {
    ...
    try {
      ...
      final profile = SeedProducerModel(
        ...
        seedVarieties: _seedVarieties,
        productionCapacity: _productionCapacityController.text.isNotEmpty
            ? double.tryParse(_productionCapacityController.text)
            : null,
      ...
      await FirestoreService().createSeedProducer(profile);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Seed Producer Profile'),
        centerTitle: true,
      ),
      body: Form(
        key: _formKey,
        ...
        children: [
          ...
          TextFormField(
            ...
            decoration: const InputDecoration(
              ...
              hintText: 'e.g., Rwanda Agriculture Board',
          ...
          TextFormField(
            ...
            decoration: const InputDecoration(
              labelText: 'Seed Production License *',
          ...
          TextFormField(
            ...
            decoration: const InputDecoration(
              labelText: 'Production Capacity (kg/season)',
              hintText: 'e.g., 50000',
  ...
  Widget _buildSeedVarietiesPage() {
    return SingleChildScrollView(
      padding: const EdgeInsets.all(16),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          ...
          const SizedBox(height: 8),
          Text(
            'Add iron-biofortified bean seed varieties you produce',
            style: Theme.of(context).textTheme.bodyMedium?.copyWith(
              color: AppTheme.textSecondaryColor,
            ),
          ),
          ...
          ElevatedButton.icon(
            ...
            label: const Text('Add Seed Variety'),
          ),
          const SizedBox(height: 16),

          if (_seedVarieties.isEmpty)
            Center(
              child: Padding(
            ...
            ListView.builder(
              shrinkWrap: true,
              physics: const NeverScrollableScrollPhysics(),
              itemCount: _seedVarieties.length,
              itemBuilder: (context, index) {
                final variety = _seedVarieties[index];
                return Card(
                  ...
                  child: ListTile(
                    ...
                    title: Text(variety.varietyName),
                    subtitle: Text(
                      '${variety.varietyCode} • Iron: ${variety.ironContent}mg/100g\n'
                      'RWF ${variety.pricePerKg}/kg • ${variety.maturityDays} days',
                    ),
                    isThreeLine: true,
                    trailing: IconButton(
                      icon: const Icon(Icons.delete, color: Colors.red),
                      onPressed: () {
                        setState(() => _seedVarieties.removeAt(index));
                      },
                    ),
                  ),
                );
          ...
          child: Column(
            ...
            children: [
              ...
              TextField(
                ...
                keyboardType: TextInputType.number,
                decoration: const InputDecoration(
                  labelText: 'Iron Content (mg/100g) *',
                  hintText: 'e.g., 85',
                ),
              ),
              const SizedBox(height: 12),
              ...
              TextField(
                ...
                decoration: const InputDecoration(
                  ...
                  hintText: 'Brief description of the variety',
                ),
              ),
            ],
          ),
          ...
          ElevatedButton(
            onPressed: () {
              if (nameController.text.isNotEmpty &&
                  ...
                  maturityController.text.isNotEmpty &&
                  priceController.text.isNotEmpty) {
                setState(() {
                  _seedVarieties.add(SeedVariety(
                    varietyName: nameController.text,
                    varietyCode: codeController.text,
                    ironContent: double.parse(ironController.text),
                    description: descController.text,
                    maturityDays: int.parse(maturityController.text),
