...
import 'institution_place_order_screen.dart';
...
class InstitutionDashboardScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: FutureBuilder<InstitutionModel?>(
        future: FirestoreService().getInstitutionByUserId(userId),
        builder: (context, snapshot) {
          ...
          return SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                // Welcome Card
                _buildWelcomeCard(context, institution),
  ...
  Widget _buildWelcomeCard(BuildContext context, InstitutionModel institution) {
    return Card(
      child: Padding(
        padding: const EdgeInsets.all(16),
        child: Row(
    ...
    return Card(
      ...
      child: InkWell(
        onTap: () {
          Navigator.of(context).push(
            MaterialPageRoute(
              builder: (context) => const InstitutionPlaceOrderScreen(),
            ),
          );
        },
        child: Padding(
              ...
              const Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 4),
                    Text(
                      'Order biofortified beans for your institution',
                      style: TextStyle(
              ...
              child: Center(
                child: Column(
                  children: [
                    ...
                    const SizedBox(height: 4),
                    Text(
                      'Start ordering biofortified beans',
                      style: TextStyle(color: Colors.grey[500], fontSize: 12),
                    ),
                  ],
                ),
